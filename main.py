...
vpnapiio_key = "" #key from vpnapi.io
...
print("Windows-View /nCopyright (c) 2024 Felix Bogomolov /nGitHub: https://github.com/FeliBog/Windows-View/tree/main-latest /n /nOS:")
